    ...
    <span className="relative w-[318px]" ref={popupRef}>
      <button
        className={clsx(
          ...
          showPopup ? "border-[#8338EC] border-[1px] rounded-[5px]" : "border-[1px]  rounded-[5px] border-[#DEE2E6]"
        )}
        type="button"
        onClick={togglePopupHandler}
      >
        <img src={CalendarIcon} alt="calendar" className="object-cover w-[16px] h-[16px]"/>
        {selectedDate}
      </button>
